...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='mot', help='mot, mot_depth')
    self.parser.add_argument('--dataset', default='jde', help='jde, visdrone, uavdt')
    self.parser.add_argument('--reid', action='store_true', help='use reid branch')
    ...
    # log
    self.parser.add_argument('--disable_tensorboard', action='store_true', 
                             help='whether disable the tensorboard')
    ...
    # depth 
    self.parser.add_argument('--min_depth', type=float, default=0.1, help='predict min depth')
    self.parser.add_argument('--max_depth', type=float, default=500, help='predict max depth')
    self.parser.add_argument('--reproj_loss_weight', type=float, default=1., help='repeojection weight in depth loss')
    self.parser.add_argument('--smooth_loss_weight', type=float, default=0.001, help='smoothness weight in depth loss')
  ...
  def init(self, args=''):
    default_dataset_info = {
      ...
      'mot_depth': {'default_resolution': [608, 1088], 'num_classes': 1,
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'jde', 'nID': 14455},
    }
    class Struct:
