...
CUDA_VISIBLE_DEVICES=1 python train.py mot_depth --dataset uavdt --exp_id uavdt --arch dladepth_32 --batch_size 4 --num_epochs 5 --hide_data_time --load_model '../models/pretrained/coco_mono_dla_depth.pth' --gpus 0 --data_cfg '../src/lib/cfg/uavdt.json'
cd ..
